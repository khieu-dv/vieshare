    ...
    <footer className={cn("border-t bg-background text-foreground", className)}>
      <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Download videos quickly and easily with VieShare. Trusted by users worldwide.
            </p>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              ...
              <li>
                <Link href="/frps" className="hover:text-foreground">
                  Frp
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 pt-8 border-t text-center text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} VieShare. All rights reserved.
        </div>
      </div>
    </footer>
  );
